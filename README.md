...
По умолчанию это dev-режим. Команда скопирует `.env.example` в `.env`, соберет и запустит контейнеры, установит зависимости, сгенерирует `APP_KEY` и применит миграции
...
Метрики тут: http://localhost:8080/metrics
